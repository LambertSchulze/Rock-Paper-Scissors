...
function playRound(playerSelection, computerSelection) {
    ...
    if (playerSelection == computerSelection) {
        ...
        message.textContent = "Computer chose Paper " + String.fromCodePoint(0x270B) + ": You loose.";
        return "computer";
    }
    else if (playerSelection   == "rock" &&
        computerSelection == "scissors") {
        message.textContent = "Computer chose Scissors " + String.fromCodePoint(0x270C) + ": This round goes to you!";
        return "player";
    }
    else if (playerSelection   == "paper" &&
        computerSelection == "rock") {
        message.textContent = "Computer chose Rock " + String.fromCodePoint(0x270A) + ": This round goes to you!";
        return "player";
    }
    else if (playerSelection   == "paper" &&
        computerSelection == "scissors") {
        message.textContent = "Computer chose Scissors " + String.fromCodePoint(0x270C) + ": You loose.";
        return "computer";
    }
    else if (playerSelection   == "scissors" &&
        computerSelection == "rock") {
        message.textContent = "Computer chose Rock " + String.fromCodePoint(0x270A) + ": You loose.";
        return "computer";
    }
    else if (playerSelection   == "scissors" &&
        computerSelection == "paper") {
        message.textContent = "Computer chose Paper " + String.fromCodePoint(0x270B) + ": This round goes to you!";
        return "player";
    }
    else {
